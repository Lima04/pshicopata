...
public class TallIpeSpawnProcedure extends NewBordersModModElements.ModElement {
	...
	public static void executeProcedure(Map<String, Object> dependencies) {
		...
		while ((((world.getBlockState(new BlockPos((int) x, (int) (y - (down)), (int) z))).getBlock() == Blocks.AIR.getDefaultState().getBlock())
				|| ((world.getBlockState(new BlockPos((int) x, (int) (y - (down)), (int) z))).getBlock() == TallIpeAirBlock.block.getDefaultState()
						.getBlock()))) {
			down = (double) ((down) + 1);
		}
		...
		if (((world.getBlockState(new BlockPos((int) x, (int) (y - (down)), (int) z))).getBlock() == TallIpeAirBlock.block.getDefaultState()
				.getBlock())) {
