...
public class SulfurOreBlock extends NewBordersModModElements.ModElement {
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			CUSTOM_MATCH = Registry.register(Registry.RULE_TEST, new ResourceLocation("new_borders_mod:sulfur_ore_match"),
			...
			event.getRegistry().register(feature.setRegistryName("sulfur_ore"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("new_borders_mod:sulfur_ore"), configuredFeature);
		}
	}
	@SubscribeEvent
