...
import net.mcreator.newbordersmod.entity.renderer.MooglowRenderer;
...
public class MooglowEntity extends NewBordersModModElements.ModElement {
	public static EntityType entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.CREATURE)
			...
			.size(0.9f, 1.4f)).build("mooglow").setRegistryName("mooglow");
	public MooglowEntity(NewBordersModModElements instance) {
		super(instance, 189);
		FMLJavaModLoadingContext.get().getModEventBus().register(new MooglowRenderer.ModelRegisterHandler());
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -16776961, -3355444, new Item.Properties().group(ItemGroup.MISC))
				.setRegistryName("mooglow_spawn_egg"));
	}
