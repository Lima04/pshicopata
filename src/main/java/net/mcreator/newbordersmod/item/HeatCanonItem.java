...
public class HeatCanonItem extends NewBordersModModElements.ModElement {
			...
			if (!world.isRemote && entityLiving instanceof ServerPlayerEntity) {
				...
				if (true) {
					...
					if (entity.abilities.isCreativeMode || stack != ItemStack.EMPTY) {
						ArrowCustomEntity entityarrow = shoot(world, entity, random, 3f, 7.3999999999999995, 1);
	...
	public static class ArrowCustomEntity extends AbstractArrowEntity implements IRendersAsItem {
		...
		public ItemStack getItem() {
			return new ItemStack(HeatedLeadItem.block, (int) (1));
		}
			...
			if (this.inGround) {
				{
					...
					HeatCanonBulletHitsBlockProcedure.executeProcedure($_dependencies);
				}
				this.remove();
			}
		}
	...
	public static ArrowCustomEntity shoot(LivingEntity entity, LivingEntity target) {
		...
		entityarrow.setSilent(true);
		entityarrow.setDamage(7.3999999999999995);
