...
public class CleanerSentinelEntity extends NewBordersModModElements.ModElement {
	...
	public void initElements() {
		entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.AMBIENT).setShouldReceiveVelocityUpdates(true)
				.setTrackingRange(64).setUpdateInterval(3).setCustomClientFactory(CustomEntity::new).size(0.6f, 1.8f)).build("cleaner_sentinel")
						.setRegistryName("cleaner_sentinel");
		elements.entities.add(() -> entity);
		elements.items.add(() -> new SpawnEggItem(entity, -6710887, -16763905, new Item.Properties().group(ItemGroup.MISC))
	...
	public void registerModels(ModelRegistryEvent event) {
		RenderingRegistry.registerEntityRenderingHandler(entity, renderManager -> {
			return new MobRenderer(renderManager, new ModelSentinel(), 0.5f) {
				@Override
	...
	public static class CustomEntity extends CreatureEntity {
		...
		protected void registerGoals() {
			super.registerGoals();
			this.goalSelector.addGoal(1, new BreakBlockGoal(Blocks.GRASS.getDefaultState().getBlock(), this, 1, (int) 32));
			this.goalSelector.addGoal(2, new BreakBlockGoal(Blocks.TALL_GRASS.getDefaultState().getBlock(), this, 1, (int) 32));
			this.goalSelector.addGoal(3, new BreakBlockGoal(Blocks.FERN.getDefaultState().getBlock(), this, 1, (int) 32));
			this.goalSelector.addGoal(4, new BreakBlockGoal(Blocks.COBBLESTONE.getDefaultState().getBlock(), this, 1, (int) 32));
			this.goalSelector.addGoal(5, new BreakBlockGoal(Blocks.DEAD_BUSH.getDefaultState().getBlock(), this, 1, (int) 32));
		...
		public net.minecraft.util.SoundEvent getAmbientSound() {
			return (net.minecraft.util.SoundEvent) ForgeRegistries.SOUND_EVENTS
					.getValue(new ResourceLocation("new_borders_mod:cleanersentinelsound"));
		}
