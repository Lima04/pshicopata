...
import net.mcreator.newbordersmod.procedures.BabacuAir2FruitGenerateProcedure;
...
public class BabacuType2AirFruitStructure extends NewBordersModModElements.ModElement {
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
					...
					if ((random.nextInt(1000000) + 1) <= 150000) {
						...
						for (int a = 0; a < count; a++) {
									...
									random);
							{
								...
								BabacuAir2FruitGenerateProcedure.executeProcedure($_dependencies);
							}
						}
					}
					return true;
			...
			event.getRegistry().register(feature.setRegistryName("babacu_type_2_air_fruit"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("new_borders_mod:babacu_type_2_air_fruit"),
					configuredFeature);
		}
	}
	@SubscribeEvent
