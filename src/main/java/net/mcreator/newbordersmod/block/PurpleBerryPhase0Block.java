...
import net.mcreator.newbordersmod.procedures.PurpleBerryPhase0to1Procedure;
import net.mcreator.newbordersmod.procedures.PurpleBerryPhase0OnBlockRightClickedProcedure;
...
public class PurpleBerryPhase0Block extends NewBordersModModElements.ModElement {
	...
	public static class CustomBlock extends FallingBlock {
		public CustomBlock() {
			...
			setRegistryName("purple_berry_phase_0");
		}
		...
		public void tick(BlockState state, ServerWorld world, BlockPos pos, Random random) {
			...
			int z = pos.getZ();
			{
				...
				PurpleBerryPhase0to1Procedure.executeProcedure($_dependencies);
			}
			world.getPendingBlockTicks().scheduleTick(new BlockPos(x, y, z), this, 12000);
		}
		...
		public ActionResultType onBlockActivated(BlockState state, World world, BlockPos pos, PlayerEntity entity, Hand hand,
			...
			Direction direction = hit.getFace();
			{
				...
				$_dependencies.put("z", z);
				$_dependencies.put("world", world);
				PurpleBerryPhase0OnBlockRightClickedProcedure.executeProcedure($_dependencies);
			}
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			CUSTOM_MATCH = Registry.register(Registry.RULE_TEST, new ResourceLocation("new_borders_mod:purple_berry_phase_0_match"),
			...
			event.getRegistry().register(feature.setRegistryName("purple_berry_phase_0"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("new_borders_mod:purple_berry_phase_0"), configuredFeature);
		}
	}
	@SubscribeEvent
