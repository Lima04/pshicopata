...
public class CyanRoseBlock extends NewBordersModModElements.ModElement {
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			...
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("new_borders_mod:cyan_rose"), configuredFeature);
		}
	}
	@SubscribeEvent
