...
import net.mcreator.newbordersmod.entity.renderer.SentinelRenderer;
...
public class SentinelEntity extends NewBordersModModElements.ModElement {
	public static EntityType entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.MONSTER)
			...
			.size(0.7f, 1f)).build("sentinel").setRegistryName("sentinel");
	public SentinelEntity(NewBordersModModElements instance) {
		super(instance, 198);
		FMLJavaModLoadingContext.get().getModEventBus().register(new SentinelRenderer.ModelRegisterHandler());
