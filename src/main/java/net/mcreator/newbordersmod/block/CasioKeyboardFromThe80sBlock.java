...
import net.mcreator.newbordersmod.procedures.CasioKeyboardFromThe80sOnBlockRightClickedProcedure;
...
public class CasioKeyboardFromThe80sBlock extends NewBordersModModElements.ModElement {
	...
	public static class CustomBlock extends Block {
		...
		public ActionResultType onBlockActivated(BlockState state, World world, BlockPos pos, PlayerEntity entity, Hand hand,
			...
			Direction direction = hit.getFace();
			{
				...
				CasioKeyboardFromThe80sOnBlockRightClickedProcedure.executeProcedure($_dependencies);
			}
