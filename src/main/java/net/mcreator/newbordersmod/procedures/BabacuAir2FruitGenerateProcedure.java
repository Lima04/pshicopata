...
public class BabacuAir2FruitGenerateProcedure extends NewBordersModModElements.ModElement {
	...
	public static void executeProcedure(Map<String, Object> dependencies) {
		...
		while ((((world.getBlockState(new BlockPos((int) x, (int) (y - (down)), (int) z))).getBlock() == Blocks.AIR.getDefaultState().getBlock())
				|| ((world.getBlockState(new BlockPos((int) x, (int) (y - (down)), (int) z))).getBlock() == BabacuAir2FruitItem.block
		...
		if (((world.getBlockState(new BlockPos((int) x, (int) (y - (down)), (int) z))).getBlock() == BabacuAir2FruitItem.block.getDefaultState()
				.getBlock())) {
