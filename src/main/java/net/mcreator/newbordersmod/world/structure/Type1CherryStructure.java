...
import net.mcreator.newbordersmod.procedures.CherryType1Procedure;
...
public class Type1CherryStructure extends NewBordersModModElements.ModElement {
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
					...
					if ((random.nextInt(1000000) + 1) <= 140000) {
						...
						for (int a = 0; a < count; a++) {
									...
									random);
							{
								...
								CherryType1Procedure.executeProcedure($_dependencies);
							}
						}
					}
					return true;
			...
			event.getRegistry().register(feature.setRegistryName("type_1_cherry"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("new_borders_mod:type_1_cherry"), configuredFeature);
		}
	}
	@SubscribeEvent
