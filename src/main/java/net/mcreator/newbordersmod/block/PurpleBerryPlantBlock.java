...
import net.mcreator.newbordersmod.procedures.PurpleBerryPlantUpdateTickProcedure;
import net.mcreator.newbordersmod.procedures.Phase1to2bonemealProcedure;
...
public class PurpleBerryPlantBlock extends NewBordersModModElements.ModElement {
	...
	public static class CustomBlock extends FallingBlock {
		...
		public ActionResultType onBlockActivated(BlockState state, World world, BlockPos pos, PlayerEntity entity, Hand hand,
			...
			Direction direction = hit.getFace();
			{
				...
				$_dependencies.put("z", z);
				$_dependencies.put("world", world);
				Phase1to2bonemealProcedure.executeProcedure($_dependencies);
			}
