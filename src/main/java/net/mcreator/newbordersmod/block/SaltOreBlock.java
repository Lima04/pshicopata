...
public class SaltOreBlock extends NewBordersModModElements.ModElement {
	...
	public void init(FMLCommonSetupEvent event) {
		for (Biome biome : ForgeRegistries.BIOMES.getValues()) {
			...
			if (ForgeRegistries.BIOMES.getKey(biome).equals(new ResourceLocation("new_borders_mod:salt_flats")))
				biomeCriteria = true;
			...
			}), block.getDefaultState(), 11)).withPlacement(Placement.COUNT_RANGE.configure(new CountRangeConfig(8, 28, 28, 64))));
		}
	}
}
