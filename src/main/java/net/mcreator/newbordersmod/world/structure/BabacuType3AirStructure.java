...
import net.mcreator.newbordersmod.procedures.BabacuAir3GeneratorProcedure;
...
public class BabacuType3AirStructure extends NewBordersModModElements.ModElement {
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			...
			event.getRegistry().register(feature.setRegistryName("babacu_type_3_air"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("new_borders_mod:babacu_type_3_air"), configuredFeature);
		}
	}
	@SubscribeEvent
