...
public class TropicalSavannaBiome extends NewBordersModModElements.ModElement {
	...
	public void init(FMLCommonSetupEvent event) {
		...
		BiomeManager.addBiome(BiomeManager.BiomeType.WARM, new BiomeManager.BiomeEntry(biome, 17));
	}
	static class CustomBiome extends Biome {
		public CustomBiome() {
			super(new Biome.Builder().downfall(0.5f).depth(0.4f).scale(0.3f).temperature(1f).precipitation(Biome.RainType.RAIN)
					.category(Biome.Category.SAVANNA).waterColor(4159204).waterFogColor(329011).parent("jungle")
					.surfaceBuilder(SurfaceBuilder.DEFAULT, new SurfaceBuilderConfig(Blocks.GRASS_BLOCK.getDefaultState(),
							Blocks.LIGHT_GRAY_TERRACOTTA.getDefaultState(), Blocks.LIGHT_GRAY_TERRACOTTA.getDefaultState())));
			setRegistryName("tropical_savanna");
