...
public class MosquitoEntity extends NewBordersModModElements.ModElement {
	...
	public void initElements() {
		entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.MONSTER).setShouldReceiveVelocityUpdates(true)
				.setTrackingRange(64).setUpdateInterval(3).setCustomClientFactory(CustomEntity::new).size(0.5f, 0.5f)).build("mosquito")
						.setRegistryName("mosquito");
		elements.entities.add(() -> entity);
		elements.items.add(() -> new SpawnEggItem(entity, -10053376, -10027060, new Item.Properties().group(ItemGroup.MISC))
				.setRegistryName("mosquito_spawn_egg"));
	}
	...
	public static class CustomEntity extends MonsterEntity {
		...
		protected void registerGoals() {
			...
			this.targetSelector.addGoal(6, new NearestAttackableTargetGoal(this, WolfEntity.class, false, false));
			this.targetSelector.addGoal(7, new NearestAttackableTargetGoal(this, CowEntity.class, false, false));
			...
			this.targetSelector.addGoal(10, new NearestAttackableTargetGoal(this, ChickenEntity.class, false, false));
			this.targetSelector.addGoal(11, new NearestAttackableTargetGoal(this, PigEntity.class, false, false));
			this.targetSelector.addGoal(12, new NearestAttackableTargetGoal(this, PandaEntity.class, false, false));
			this.goalSelector.addGoal(13, new AvoidEntityGoal(this, CaveSpiderEntity.class, (float) 6, 1, 1.2));
			this.goalSelector.addGoal(14, new AvoidEntityGoal(this, SpiderEntity.class, (float) 6, 1, 1.2));
			this.goalSelector.addGoal(15, new AvoidEntityGoal(this, SilverfishEntity.class, (float) 6, 1, 1.2));
		}
		...
		public net.minecraft.util.SoundEvent getAmbientSound() {
			return (net.minecraft.util.SoundEvent) ForgeRegistries.SOUND_EVENTS.getValue(new ResourceLocation("new_borders_mod:msoquitao"));
		}

		@Override
		public net.minecraft.util.SoundEvent getHurtSound(DamageSource ds) {
			return (net.minecraft.util.SoundEvent) ForgeRegistries.SOUND_EVENTS.getValue(new ResourceLocation("entity.hostile.hurt"));
		}

		@Override
		public net.minecraft.util.SoundEvent getDeathSound() {
			return (net.minecraft.util.SoundEvent) ForgeRegistries.SOUND_EVENTS.getValue(new ResourceLocation("entity.hostile.death"));
		}
