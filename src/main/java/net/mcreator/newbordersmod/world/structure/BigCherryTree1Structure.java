...
public class BigCherryTree1Structure extends NewBordersModModElements.ModElement {
	public BigCherryTree1Structure(NewBordersModModElements instance) {
		super(instance, 272);
	}
				...
				if ((random.nextInt(1000000) + 1) <= 190000) {
					...
					for (int a = 0; a < count; a++) {
						...
						Template template = ((ServerWorld) world.getWorld()).getSaveHandler().getStructureTemplateManager()
								.getTemplateDefaulted(new ResourceLocation("new_borders_mod", "big_cherry_tree_1"));
						if (template == null)
							return false;
