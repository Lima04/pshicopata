...
import net.mcreator.newbordersmod.entity.renderer.BabacuRangedRenderer;
import net.mcreator.newbordersmod.NewBordersModModElements;

import java.util.Random;

@NewBordersModModElements.ModElement.Tag
public class BabacuRangedItem extends NewBordersModModElements.ModElement {
	@ObjectHolder("new_borders_mod:babacu_ranged")
	public static final Item block = null;
	public static final EntityType arrow = (EntityType.Builder.<ArrowCustomEntity>create(ArrowCustomEntity::new, EntityClassification.MISC)
			.setShouldReceiveVelocityUpdates(true).setTrackingRange(64).setUpdateInterval(1).setCustomClientFactory(ArrowCustomEntity::new)
			.size(0.5f, 0.5f)).build("entitybulletbabacu_ranged").setRegistryName("entitybulletbabacu_ranged");
	public BabacuRangedItem(NewBordersModModElements instance) {
		super(instance, 224);
		FMLJavaModLoadingContext.get().getModEventBus().register(new BabacuRangedRenderer.ModelRegisterHandler());
	}
	...
	public static class ArrowCustomEntity extends AbstractArrowEntity implements IRendersAsItem {
		...
		public ItemStack getItem() {
			return new ItemStack(BabacuRangedItem.block, (int) (1));
		}
