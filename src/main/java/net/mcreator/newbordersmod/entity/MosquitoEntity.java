...
import net.mcreator.newbordersmod.entity.renderer.MosquitoRenderer;
...
public class MosquitoEntity extends NewBordersModModElements.ModElement {
	public static EntityType entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.MONSTER)
			...
			.size(0.3f, 0.3f)).build("mosquito").setRegistryName("mosquito");
	public MosquitoEntity(NewBordersModModElements instance) {
		super(instance, 192);
		FMLJavaModLoadingContext.get().getModEventBus().register(new MosquitoRenderer.ModelRegisterHandler());
