...
public class BabacuLeavesBlock extends NewBordersModModElements.ModElement {
	...
	public static class CustomBlock extends Block {
		...
		public CustomBlock() {
			super(
					...
					Block.Properties.create(Material.WOOD).sound(SoundType.BAMBOO).hardnessAndResistance(0.2f, 0.2f).lightValue(0).notSolid());
